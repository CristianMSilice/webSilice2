...
export class MapaMundiComponent implements OnInit {
  ...
  sedes = [
    {
      name: 'panama', text: 'Panamá', image: 'flag-panama.png', link: 'nosotros/sedes/panama',
      ...
      {
        name: 'colombia', text: 'Colombia', image: 'flag-colombia.png', link: 'nosotros/sedes/colombia',
      ...
      {
        name: 'spain', text: 'España', image: 'flag-spain.png', link: 'nosotros/sedes/espana',
