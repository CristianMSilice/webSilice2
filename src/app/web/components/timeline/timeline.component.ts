...
export class TimelineComponent implements OnInit {
  ...
  data=[
    ...
    {text:"Damos apertura a la primera oficina de negocios en Latinoamérica con las sedes de Panamá y Bogotá. Fruto de este trabajo y compromiso, somos seleccionada por el Gobierno de Panamá para realizar la Consultoría de <strong>Transformación Digital</strong> del proyecto de Modernización Municipal.", name:"Una visión: Play local",time:"2011"},
