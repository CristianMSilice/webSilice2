...
export class TeamComponent implements OnInit {
  sliderItem: Array<any> = [
    ...
    { image: "pedroCasasV1.jpg", name: "Pedro Casas", position: "Líder de Plataforma", chatID: "nosotros-pedro", linkedin: `https://www.linkedin.com/in/pedroip/`, email: `pedro.casas@silice.si`, text: `Análisis y desarrollo de aplicaciones e integración Bots.` },
    ...
    { image: "jonatan-final.jpg", name: "Jonnathan Díaz", position: "Country Manager Panamá", chatID: "nosotros-jonathan", linkedin: `https://www.linkedin.com/in/jonnathan-d%C3%ADaz-6890551b7/`, email: `jonnathan.diaz@silice.si`, text: `El es especialista en transformación digital e innovación a nivel municipal. Su objetivo es llevar la administración municipal al siguiente nivel de la economía digital.` },
    { image: "giovanna.jpeg", name: "Giovanna Villareal", position: "Comercial centro América y el Caribe", chatID: "nosotros-giovanna", linkedin: `https://www.linkedin.com/`, email: ``, text: `Construye la apertura de nuevos mercados, negocios y alianzas estratégicas que contribuyan al posicionamiento de las soluciones SILICE.` },
  ]
